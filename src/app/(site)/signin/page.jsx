...
export default function SigninPage() {
	...
	if (loading) {
		return (
			<main className="relative isolate min-h-screen overflow-hidden bg-white px-4 py-10 sm:px-6 lg:px-8">
				<section className="relative mx-auto w-full max-w-md rounded-lg border border-black/10 bg-white p-6 shadow-sm sm:p-8">
	...
	return (
		...
		>
			...
			<section className="relative mx-auto w-full max-w-md rounded-lg border border-black/10 bg-white p-6 shadow-[0_18px_60px_rgba(70,35,25,0.12)] sm:p-8">

...
const emptyForm = {
  ...
  title: "",
  description: "",
  allowedTabs: ["Essentials", "Invitation", "Events", "Story", "Gallery", "Info", "RSVP", "Music"],
};
    ...
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-black/5 pb-8">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-black font-heading">Add Template</h1>
          <p className="mt-2.5 max-w-xl text-sm leading-6 text-black/55">
            Configure metadata, select layout parameters, and allow specific customizer tabs.
          </p>
        </div>
        <a
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <section className="border border-black/5 bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.015)] space-y-6">
          ...
          <div className="grid gap-5">
            ...
            <label className={labelClass}>
              ...
              <textarea
                required
                placeholder="Write a descriptive overview for this theme design..."
        ...
        <aside className="space-y-6">
          ...
          <div className="border border-black/5 bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.015)]">
            ...
            <label className="mt-4 flex min-h-44 cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-black/15 bg-[#fbf9f7] p-5 text-center transition-all duration-200 hover:border-[#74313d] hover:bg-[#74313d]/2 hover:text-[#74313d]">
              <input
                type="file"
                accept="image/*"
              ...
              <span className="text-xs font-semibold text-black">{file ? file.name : "Choose Mockup Image"}</span>

...
export default function Header() {
  ...
  return (
    <header className="sticky top-2 z-1000 px-3 py-2 text-black sm:top-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-337.5 rounded-sm border border-black/8 bg-white/86 px-3 py-2 shadow-[0_18px_60px_rgba(70,35,25,0.12)] backdrop-blur-xl sm:px-5 lg:px-7">

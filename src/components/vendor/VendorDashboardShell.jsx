...
import { Bell, CalendarPlus, CreditCard, LifeBuoy, LayoutGrid, Monitor, Plus, Users, Home } from "lucide-react";
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <Button
                  type="button"
                  variant="outline"
                  className="h-11 rounded-2xl border-black/10 bg-white px-4 text-sm font-medium text-black shadow-[0_10px_24px_rgba(0,0,0,0.04)] hover:bg-black hover:text-white"

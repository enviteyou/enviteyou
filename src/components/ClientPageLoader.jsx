...
export default function ClientPageLoader({ children }) {
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    // Hide the loader once the client hydration is fully complete
    setLoading(false);
  }, []);
        ...
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#FCFAF8] px-6 text-black select-none">
          ...
          <div className="relative flex flex-col items-center max-w-md text-center z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="text-2xl sm:text-3xl font-semibold tracking-tight font-serif text-[#1e1b18] opacity-90">

...
const Hero = ({ isDarkMode }: { isDarkMode?: boolean }) => {
  ...
  return (
    <div ref={containerRef} className={`relative w-full h-[300vh] transition-colors duration-700 ${isDarkMode ? 'bg-[#050505]' : 'bg-white'}`}>
      <div className="fixed inset-0 w-full h-full overflow-hidden z-0">
        <canvas ref={canvasRef} className="w-full h-full block" />
      </div>

      <div className="sticky inset-0 z-10 flex items-center justify-center pointer-events-none">
